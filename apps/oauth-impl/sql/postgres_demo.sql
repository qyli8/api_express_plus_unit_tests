...
(1, NULL, 'democlient', 'democlientsecret', 'http://localhost:3000/profile', NULL, 'profile', 1);
...
create sequence oauth_access_tokens_id_seq;
ALTER TABLE oauth_access_tokens
  ALTER id  set default nextval('oauth_access_tokens_id_seq');
--
...
ALTER TABLE oauth_authorization_codes
  ALTER id set default nextval('oauth_authorization_codes_id_seq');
--
-- AUTO_INCREMENT for table oauth_clients
--
create sequence oauth_clients_id_seq;
ALTER TABLE oauth_clients
  ALTER id set default nextval('oauth_clients_id_seq');
--
-- AUTO_INCREMENT for table oauth_refresh_tokens
--
create sequence oauth_refresh_tokens_id_seq;
ALTER TABLE oauth_refresh_tokens
  ALTER id set default nextval('oauth_refresh_tokens_id_seq');
--
-- AUTO_INCREMENT for table oauth_scopes
--
create sequence oauth_scopes_id_seq;
ALTER TABLE oauth_scopes
  ALTER id set default nextval('oauth_scopes_id_seq');
--
